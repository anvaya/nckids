...
abstract class BaseSettingPeer {
	...
	/** the column name for the S_KEY field */
	const S_KEY = 'setting.S_KEY';

	/** the column name for the S_VALUE field */
	const S_VALUE = 'setting.S_VALUE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('SKey', 'SValue', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('sKey', 'sValue', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::S_KEY, self::S_VALUE, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('s_key', 's_value', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('SKey' => 0, 'SValue' => 1, 'Id' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('sKey' => 0, 'sValue' => 1, 'id' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::S_KEY => 0, self::S_VALUE => 1, self::ID => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('s_key' => 0, 's_value' => 1, 'id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SettingPeer::S_KEY);

		$criteria->addSelectColumn(SettingPeer::S_VALUE);
    ...
    foreach (sfMixer::getCallables('BaseSettingPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(SettingPeer::ID, $criteria->remove(SettingPeer::ID), $comparison);
