...
/**
 * Base class that represents a row from the 'employee_location' table.
 *
 * 
 *
 ...
 */
abstract class BaseEmployeeLocation extends BaseObject  implements Persistent {


  const PEER = 'EmployeeLocationPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        EmployeeLocationPeer
	 */
	...
	/**
	 * Initializes internal state of BaseEmployeeLocation object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     EmployeeLocation The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = EmployeeLocationPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = EmployeeLocationPeer::NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = EmployeeLocationPeer::NUM_COLUMNS - EmployeeLocationPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating EmployeeLocation object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = EmployeeLocationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseEmployeeLocation:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			EmployeeLocationPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseEmployeeLocation:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseEmployeeLocation:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseEmployeeLocation:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			EmployeeLocationPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = EmployeeLocationPeer::doInsert($this, $con);
					...
					$affectedRows += EmployeeLocationPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = EmployeeLocationPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = EmployeeLocationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = EmployeeLocationPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
		);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EmployeeLocationPeer::ID)) $criteria->add(EmployeeLocationPeer::ID, $this->id);
		if ($this->isColumnModified(EmployeeLocationPeer::NAME)) $criteria->add(EmployeeLocationPeer::NAME, $this->name);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(EmployeeLocationPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of EmployeeLocation (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     EmployeeLocation Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     EmployeeLocationPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new EmployeeLocationPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this EmployeeLocation has previously been saved, it will retrieve
	 * related EmployeeFingerToLocations from storage. If this EmployeeLocation is new, it will return
		...
		if ($this->collEmployeeFingerToLocations === null) {
			if ($this->isNew()) {
			   $this->collEmployeeFingerToLocations = array();
				...
				$criteria->add(EmployeeFingerToLocationPeer::LOCATION_ID, $this->id);
	 ...
	 * Otherwise if this EmployeeLocation is new, it will return
	 * an empty collection; or if this EmployeeLocation has previously
	 * been saved, it will retrieve related EmployeeFingerToLocations from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in EmployeeLocation.
	 */
	public function getEmployeeFingerToLocationsJoinEmployee($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EmployeeLocationPeer::DATABASE_NAME);
		}
		...
		if ($this->collEmployeeFingerToLocations === null) {
			if ($this->isNew()) {
				...
				$this->collEmployeeFingerToLocations = EmployeeFingerToLocationPeer::doSelectJoinEmployee($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this EmployeeLocation has previously been saved, it will retrieve
	 * related EmployeeToLocations from storage. If this EmployeeLocation is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collEmployeeToLocations === null) {
			if ($this->isNew()) {
			   $this->collEmployeeToLocations = array();
				...
				$criteria->add(EmployeeToLocationPeer::LOCATION_ID, $this->id);
	 ...
	 * actually need in EmployeeLocation.
	 */
	public function getEmployeeToLocationsJoinEmployee($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EmployeeLocationPeer::DATABASE_NAME);
		}
		...
		if ($this->collEmployeeToLocations === null) {
			if ($this->isNew()) {
				...
				$this->collEmployeeToLocations = EmployeeToLocationPeer::doSelectJoinEmployee($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseEmployeeLocation:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseEmployeeLocation::%s', $method));
    }
