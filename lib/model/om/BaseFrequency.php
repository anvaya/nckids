...
/**
 * Base class that represents a row from the 'frequency' table.
 *
 * 
 *
...
abstract class BaseFrequency extends BaseObject  implements Persistent {
  ...
  const PEER = 'FrequencyPeer';
	...
	/**
	 * The value for the weekly_hours field.
	...
	/**
	 * Get the [weekly_hours] column value.
	 * 
	 * @return     double
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = FrequencyPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = FrequencyPeer::NAME;
		}
	...
	/**
	 * Set the value of [weekly_hours] column.
	 * 
	...
	public function setWeeklyHours($v)
	{
		...
		if ($this->weekly_hours !== $v || $v === 0) {
			$this->weekly_hours = $v;
			$this->modifiedColumns[] = FrequencyPeer::WEEKLY_HOURS;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = FrequencyPeer::DESCRIPTION;
		}
	...
	public function setSortOrder($v)
	{
		...
		if ($this->sort_order !== $v) {
			$this->sort_order = $v;
			$this->modifiedColumns[] = FrequencyPeer::SORT_ORDER;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(FrequencyPeer::WEEKLY_HOURS))) {
				return false;
			}

			if ($this->weekly_hours !== 0) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->weekly_hours = ($row[$startcol + 2] !== null) ? (double) $row[$startcol + 2] : null;
			$this->description = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->sort_order = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = FrequencyPeer::NUM_COLUMNS - FrequencyPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    foreach (sfMixer::getCallables('BaseFrequency:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			FrequencyPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseFrequency:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseFrequency:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseFrequency:save:post') as $callable)
    {
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = FrequencyPeer::doInsert($this, $con);
					...
					$affectedRows += FrequencyPeer::doUpdate($this, $con);
				}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setWeeklyHours($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FrequencyPeer::ID)) $criteria->add(FrequencyPeer::ID, $this->id);
		if ($this->isColumnModified(FrequencyPeer::NAME)) $criteria->add(FrequencyPeer::NAME, $this->name);
		if ($this->isColumnModified(FrequencyPeer::WEEKLY_HOURS)) $criteria->add(FrequencyPeer::WEEKLY_HOURS, $this->weekly_hours);
		if ($this->isColumnModified(FrequencyPeer::DESCRIPTION)) $criteria->add(FrequencyPeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(FrequencyPeer::SORT_ORDER)) $criteria->add(FrequencyPeer::SORT_ORDER, $this->sort_order);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(FrequencyPeer::ID, $this->id);
	 ...
	 * Otherwise if this Frequency has previously been saved, it will retrieve
	 * related ClientServices from storage. If this Frequency is new, it will return
		...
		if ($this->collClientServices === null) {
			if ($this->isNew()) {
			   $this->collClientServices = array();
				...
				$criteria->add(ClientServicePeer::FREQUENCY_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Frequency has previously been saved, it will retrieve
	 * related NoteEntrys from storage. If this Frequency is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collNoteEntrys === null) {
			if ($this->isNew()) {
			   $this->collNoteEntrys = array();
				...
				$criteria->add(NoteEntryPeer::FREQUENCY_ID, $this->id);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseFrequency:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseFrequency::%s', $method));
    }
