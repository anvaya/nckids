...
abstract class BaseSetting extends BaseObject  implements Persistent {
  ...
  const PEER = 'SettingPeer';
	...
	/**
	 * The value for the s_key field.
	 * @var        string
	 */
	protected $s_key;

	/**
	 * The value for the s_value field.
	 * @var        string
	 */
	protected $s_value;
	...
	public function setSKey($v)
	{
		...
		if ($this->s_key !== $v) {
			$this->s_key = $v;
			$this->modifiedColumns[] = SettingPeer::S_KEY;
		}
	...
	/**
	 * Set the value of [s_value] column.
	 * 
	 * @param      string $v new value
	 * @return     Setting The current object (for fluent API support)
	 */
	public function setSValue($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->s_value !== $v) {
			$this->s_value = $v;
			$this->modifiedColumns[] = SettingPeer::S_VALUE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->s_key = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->s_value = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 3; // 3 = SettingPeer::NUM_COLUMNS - SettingPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setSKey($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setSValue($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SettingPeer::S_KEY)) $criteria->add(SettingPeer::S_KEY, $this->s_key);
		if ($this->isColumnModified(SettingPeer::S_VALUE)) $criteria->add(SettingPeer::S_VALUE, $this->s_value);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setSKey($this->s_key);

		$copyObj->setSValue($this->s_value);
