...
/**
 * Base static class for performing query and update operations on the 'level' table.
 *
 * 
 *
...
abstract class BaseLevelPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Level';
    ...
    foreach (sfMixer::getCallables('BaseLevelPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseLevelPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseLevelPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseLevelPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseLevelPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseLevelPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseLevelPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseLevelPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseLevelPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseLevelPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseLevelPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseLevelPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the level table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			LevelPeer::doOnDeleteSetNull(new Criteria(LevelPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			LevelPeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = LevelPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {

			// set fkey col in related EntryConcern rows to NULL
			$selectCriteria = new Criteria(LevelPeer::DATABASE_NAME);
			$updateValues = new Criteria(LevelPeer::DATABASE_NAME);
			$selectCriteria->add(EntryConcernPeer::LEVEL_ID, $obj->getId());
			$updateValues->add(EntryConcernPeer::LEVEL_ID, null);
	...
	public static function doValidate(Level $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(LevelPeer::DATABASE_NAME, LevelPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        foreach ($res as $failed) {
            $col = LevelPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
