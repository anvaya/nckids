...
abstract class BasesfGuardUserProfilePeer {
	...
	const EMPLOYEE_ID = 'sf_guard_user_profile.EMPLOYEE_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'EmployeeId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'employeeId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::EMPLOYEE_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'employee_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'EmployeeId' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'employeeId' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::EMPLOYEE_ID => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'employee_id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::EMPLOYEE_ID);
	...
	public static function doCountJoinEmployee(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(sfGuardUserProfilePeer::EMPLOYEE_ID,), array(EmployeePeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of sfGuardUserProfile objects pre-filled with their Employee objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of sfGuardUserProfile objects.
	...
	public static function doSelectJoinEmployee(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(sfGuardUserProfilePeer::EMPLOYEE_ID,), array(EmployeePeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (sfGuardUserProfile) to $obj2 (Employee)
				$obj2->addsfGuardUserProfile($obj1);
      ...
      call_user_func($callable, 'BasesfGuardUserProfilePeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (sfGuardUserProfile) to the collection in $obj3 (Employee)
      ...
      call_user_func($callable, 'BasesfGuardUserProfilePeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = sfGuardUserProfilePeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (sfGuardUserProfile) to the collection in $obj2 (Employee)
				$obj2->addsfGuardUserProfile($obj1);
	...
	/**
	 * Selects a collection of sfGuardUserProfile objects pre-filled with all related objects except Employee.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
