  ...
  const PEER = 'sfGuardUserProfilePeer';
	...
	public function setEmployeeId($v)
	{
		...
		if ($this->employee_id !== $v) {
			$this->employee_id = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::EMPLOYEE_ID;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::EMPLOYEE_ID)) $criteria->add(sfGuardUserProfilePeer::EMPLOYEE_ID, $this->employee_id);
	...
	public function getEmployee(PropelPDO $con = null)
	{
		if ($this->aEmployee === null && ($this->employee_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aEmployee->addsfGuardUserProfiles($this);
			 */
		}
