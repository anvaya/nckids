...
abstract class BaseJob extends BaseObject  implements Persistent {
  ...
  const PEER = 'JobPeer';
	...
	/**
	 * @var        array AreaOfConcern[] Collection to store aggregation of AreaOfConcern objects.
	 */
	protected $collAreaOfConcerns;

	/**
	 * @var        Criteria The criteria used to select the current contents of collAreaOfConcerns.
	 */
	private $lastAreaOfConcernCriteria = null;
	...
	public function setAltName($v)
	{
		...
		if ($this->alt_name !== $v) {
			$this->alt_name = $v;
			$this->modifiedColumns[] = JobPeer::ALT_NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = JobPeer::NUM_COLUMNS - JobPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collAreaOfConcerns = null;
			$this->lastAreaOfConcernCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collAreaOfConcerns !== null) {
				foreach ($this->collAreaOfConcerns as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(JobPeer::ALT_NAME)) $criteria->add(JobPeer::ALT_NAME, $this->alt_name);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getAreaOfConcerns() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addAreaOfConcern($relObj->copy($deepCopy));
				}
			}
	 ...
	 * related Employees from storage. If this Job is new, it will return
		...
		if ($this->collEmployees === null) {
			if ($this->isNew()) {
			   $this->collEmployees = array();
				...
				$criteria->add(EmployeePeer::JOB_ID, $this->id);
	...
	/**
	 * Clears out the collAreaOfConcerns collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addAreaOfConcerns()
	 */
	public function clearAreaOfConcerns()
	{
		$this->collAreaOfConcerns = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collAreaOfConcerns collection (array).
	 *
	 * By default this just sets the collAreaOfConcerns collection to an empty array (like clearcollAreaOfConcerns());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initAreaOfConcerns()
	{
		$this->collAreaOfConcerns = array();
	}

	/**
	 * Gets an array of AreaOfConcern objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Job has previously been saved, it will retrieve
	 * related AreaOfConcerns from storage. If this Job is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array AreaOfConcern[]
	 * @throws     PropelException
	 */
	public function getAreaOfConcerns($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(JobPeer::DATABASE_NAME);
		}
		...
		if ($this->collAreaOfConcerns === null) {
			if ($this->isNew()) {
			   $this->collAreaOfConcerns = array();
				...
				$criteria->add(AreaOfConcernPeer::JOB_ID, $this->id);

				AreaOfConcernPeer::addSelectColumns($criteria);
				$this->collAreaOfConcerns = AreaOfConcernPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				AreaOfConcernPeer::addSelectColumns($criteria);
				if (!isset($this->lastAreaOfConcernCriteria) || !$this->lastAreaOfConcernCriteria->equals($criteria)) {
					$this->collAreaOfConcerns = AreaOfConcernPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastAreaOfConcernCriteria = $criteria;
		return $this->collAreaOfConcerns;
	}

	/**
	 * Returns the number of related AreaOfConcern objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related AreaOfConcern objects.
	 * @throws     PropelException
	 */
	public function countAreaOfConcerns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(JobPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collAreaOfConcerns === null) {
			if ($this->isNew()) {
				...
				$count = AreaOfConcernPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastAreaOfConcernCriteria) || !$this->lastAreaOfConcernCriteria->equals($criteria)) {
					...
					$count = count($this->collAreaOfConcerns);
				}
			} else {
				$count = count($this->collAreaOfConcerns);
			}
	...
	/**
	 * Method called to associate a AreaOfConcern object to this object
	 * through the AreaOfConcern foreign key attribute.
	 *
	 * @param      AreaOfConcern $l AreaOfConcern
	 * @return     void
	 * @throws     PropelException
	 */
	public function addAreaOfConcern(AreaOfConcern $l)
	{
		if ($this->collAreaOfConcerns === null) {
			$this->initAreaOfConcerns();
		}
		if (!in_array($l, $this->collAreaOfConcerns, true)) { // only add it if the **same** object is not already associated
			array_push($this->collAreaOfConcerns, $l);
			$l->setJob($this);
		}
	}
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collAreaOfConcerns) {
				foreach ((array) $this->collAreaOfConcerns as $o) {
					$o->clearAllReferences($deep);
				}
			}
		} // if ($deep)
