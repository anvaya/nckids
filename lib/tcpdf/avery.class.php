...
class Avery extends TCPDF {
    ...
    var $_Avery_Labels = array(
        '5160' => array('paper-size'=>'letter',    'metric'=>'mm',    'marginLeft'=>1.8,    'marginTop'=>10.7,        'NX'=>3,    'NY'=>10,    'SpaceX'=>6,    'SpaceY'=>0,    'width'=>67,    'height'=>26.2,        'font-size'=>8),
    ...
    // Constructor
    function Avery($format, $unit='mm', $posX=1, $posY=1) {
        if (is_array($format)) {
            // Custom format
            $Tformat = $format;
        } else {
