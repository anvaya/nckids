...
<?php if (!$form->getObject()->isNew() && $sf_user->hasCredential('delete_client_services')): ?>
  <li><?php echo link_to('Delete', 'program/delete?id='.$form->getObject()->getId(), array('method' => 'delete', 'confirm' => 'Are you sure?')) ?></li>
<?php endif; ?>
</ul>
</form>
